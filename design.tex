...
We propose \oursys, which is a Memory Allocator for I/O, used exclusively by a specific user-process and the kernel device drivers. %\oursys utilizes a pool of 2MB Huge Pages. 
