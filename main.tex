...
There is a rich literature base spanning 50 years on zero-copy techniques, non provide a full solution\cite{song2012performance}. \oursys is a much-needed step forward towards a performant and generic zero-copy technique. %A solution that we presume can be applied both to virtual and physical environments.
%We Rule.
